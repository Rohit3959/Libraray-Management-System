         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn btn-lg btn-block btn-success mt-2" runat="server" Text="Add" OnClick="Button1_Click" Visible="False" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-warning mt-2" runat="server" Text="Update" OnClick="Button3_Click" Visible="False" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger mt-2" runat="server" Text="Delete" OnClick="Button2_Click" Visible="False" />
                     </div>
                  </div>
               </div>
            </div>
